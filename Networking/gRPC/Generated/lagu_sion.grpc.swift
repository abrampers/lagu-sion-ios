...
public protocol Lagusion_LaguSionServiceClientProtocol: GRPCClient {
  ...
  ) -> UnaryCall<SwiftProtobuf.Google_Protobuf_Empty, Lagusion_ListSongResponse>

  func listSongs(
    _ request: Lagusion_ListSongsRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Lagusion_ListSongsRequest, Lagusion_ListSongResponse>
...
extension Lagusion_LaguSionServiceClientProtocol {
  ...
  public func listAllSongs(
    _ request: SwiftProtobuf.Google_Protobuf_Empty,
    callOptions: CallOptions? = nil
  ) -> UnaryCall<SwiftProtobuf.Google_Protobuf_Empty, Lagusion_ListSongResponse> {
    return self.makeUnaryCall(
      path: "/lagusion.LaguSionService/ListAllSongs",
      request: request,
...
public final class Lagusion_LaguSionServiceTestClient: Lagusion_LaguSionServiceClientProtocol {
  ...
  /// Make a unary response for the ListAllSongs RPC. This must be called
  /// before calling 'listAllSongs'. See also 'FakeUnaryResponse'.
  ///
  /// - Parameter requestHandler: a handler for request parts sent by the RPC.
  public func makeListAllSongsResponseStream(
    _ requestHandler: @escaping (FakeRequestPart<SwiftProtobuf.Google_Protobuf_Empty>) -> () = { _ in }
  ) -> FakeUnaryResponse<SwiftProtobuf.Google_Protobuf_Empty, Lagusion_ListSongResponse> {
    return self.fakeChannel.makeFakeUnaryResponse(path: "/lagusion.LaguSionService/ListAllSongs", requestHandler: requestHandler)
  }

  public func enqueueListAllSongsResponse(
    _ response: Lagusion_ListSongResponse,
    _ requestHandler: @escaping (FakeRequestPart<SwiftProtobuf.Google_Protobuf_Empty>) -> () = { _ in }
  )  {
    let stream = self.makeListAllSongsResponseStream(requestHandler)
    // This is the only operation on the stream; try! is fine.
    try! stream.sendMessage(response)
  }

  /// Returns true if there are response streams enqueued for 'ListAllSongs'
  public var hasListAllSongsResponsesRemaining: Bool {
    return self.fakeChannel.hasFakeResponseEnqueued(forPath: "/lagusion.LaguSionService/ListAllSongs")
  }
  ...
  public func makeListSongsResponseStream(
    _ requestHandler: @escaping (FakeRequestPart<Lagusion_ListSongsRequest>) -> () = { _ in }
  ) -> FakeUnaryResponse<Lagusion_ListSongsRequest, Lagusion_ListSongResponse> {
